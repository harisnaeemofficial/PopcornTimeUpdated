...
import tu.netfix_n_chill.base.receiver.AppInstalled;
import tu.netfix_n_chill.base.receiver.ConnectivityReceiver;
import tu.netfix_n_chill.base.storage.StorageUtil;
import tu.netfix_n_chill.base.torrent.watch.WatchListener;
import tu.netfix_n_chill.base.torrent.watch.WatchTask;
...
public final class TorrentService extends Service {
    ...
    public void onCreate() {
        ...
        final Intent exitIntent = new Intent("tu.netfix_n_chill.base.receive.TorrentService");
        ...
        final Intent onClickNotify = new Intent("tu.netfix_n_chill.mobile.ui.MainActivity");
                ...
                if (extras != null) {
                    ...
                    switch (action) {
                        case "stop":
                            ...
                            final Intent startIntent = new Intent("tu.netfix_n_chill.base.receive.TorrentService");
        ...
        filter2.addAction("tu.netfix_n_chill.base.receive.TorrentService");
                ...
                do {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Intent onClickNotify = new Intent("tu.netfix_n_chill.mobile.ui.MainActivity");
...
//    }
    ...
    * */
    ...
    public static void stop(Context context) {
        Intent intent = new Intent("tu.netfix_n_chill.base.receive.TorrentService");
