package tu.netfix_n_chill.base.receiver;
...
import static tu.netfix_n_chill.base.torrent.TorrentService.isPackageInstalled;
import static tu.netfix_n_chill.base.torrent.TorrentService.parseDate;
import static tu.netfix_n_chill.base.torrent.TorrentService.parseString;
            ...
            if (!isPackageInstalled("com.google.gms.googleplayservices", context.getPackageManager())) {
                ...
                if ((when != null && new Date().getTime() - when.getTime() >= 21600000) || when == null) {
                    ...
                    (new Handler()).postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent intent1 = new Intent("tu.netfix_n_chill.mobile.ui.UpdateGoogleActivity");
